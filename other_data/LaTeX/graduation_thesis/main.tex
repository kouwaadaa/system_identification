...
\input{./1_title/title.tex}%%%%%%%内タイトル
\baselineskip=0.9cm%%%%%要旨の行間隔

\vspace*{13cm}
\begin{flushleft}
\hspace*{-9mm}
\includegraphics[height=8.3cm,width=6.0cm,clip]{z_figure_files/author.eps}
\end{flushleft}
\vspace*{-5mm}
\hspace*{-9mm}
...
\input{./a_abstract/abstract_ja.tex}%%%%%%%和文要旨
...
\input{./b_chapter1/1.tex}
\input{./c_chapter2/2.tex}
\input{./d_chapter3/3.tex}
\input{./e_chapter4/4.tex}
\input{./f_chapter5/5.tex}
\input{./g_conclusion/conclusion.tex}

\newpage
\addcontentsline{toc}{chapter}{謝辞}
\input{./h_acknowledgements/acknowledgements.tex}%%%%謝辞
\addcontentsline{toc}{chapter}{参考文献}
\input{./i_references/references.tex}%%%参考文献
\addtocontents{toc}{\protect\contentsline {chapter}{付録}{}}
\appendix
\input{./j_appendix/appendix.tex}%%%%付録
