...
\begin{equation*}
  ...
  \left[
  \begin{array}{c}
    C_L(1) \quad C_L(2) \quad \hdots \quad C_L(N)
  \end{array}
  \right]^{\mathrm{T}} :
  \mbox{式(\ref{eq:LD_to_XZ})から計算される$N\times1$ベクトル}
\end{equation*}
\begin{equation*}
  \mbox{\boldmath $\theta$} =
  \left[
  \begin{array}{c}
    C_{L_0} \quad C_{L_\alpha} \quad C_{L_\dot{\alpha}}} \quad C_{L_q} \quad C_{L_{\delta_e}}
  \end{array}
  \right]^{\mathrm{T}} :
  \mbox{未知パラメータの$5\times1$ベクトル}
\end{equation*}
\begin{equation*}
  \mbox{\boldmath $X$} =
  \left[
  \begin{array}{c}
    ...
    \mbox{\boldmath $\delta_e$}
  \end{array}
  \right] :
  \mbox{ログデータから得られる$N\times4$行列}
\end{equation*}
\begin{equation*}
  \mbox{\boldmath $\nu$} =
  \left[
