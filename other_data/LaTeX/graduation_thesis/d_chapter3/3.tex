...
\begin{equation}
  ...
  \right]
\end{equation}
となる．よって，対気速度\mbox{\boldmath $V_a$}の大きさを$V_a$とすると
\begin{equation}
...
以上は一般的な航空機における空気力モデルである（以下，従来モデルと表記）．しかし，開発機体の回転翼機モードでの飛行では，ロータの吸い込みによって発生する，対気速度に比例する抗力\cite{yamana}\cite{heyson}と同様に対気速度に比例した揚力およびピッチモーメントが発生するとして，本研究では次のようなモデル式を提案している（以下，提案モデルと表記）．
\begin{align}
...
\begin{figure}[H]
	\centering
	\includegraphics[clip,width=13cm,bb=0 0 949 698]{./z_figure_files/chapter3/6_xz_force.jpeg}
